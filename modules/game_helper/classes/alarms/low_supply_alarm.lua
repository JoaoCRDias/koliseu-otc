    ...
    if children[index] then
      if enabled then
        if index == editingIndex then
          children[index]:setBackgroundColor('#3a6a3a88')
        else
          children[index]:setBackgroundColor('#00000022')
        end
      else
        children[index]:setBackgroundColor('#6a3a3a88')
      end
    end
  end
...
_Helper.LowSupplyAlarm.updateRuleSelection = function()
  ...
  for i, child in ipairs(children) do
    ...
    if isSelected then
      child:setBackgroundColor('#3a6a3a88')
    elseif not isEnabled then
      child:setBackgroundColor('#6a3a3a88')
    else
      child:setBackgroundColor('#00000022')
    end
  end
end
  ...
  for i, rule in ipairs(profile.rules) do
    ...
    if enableCheck then
      ...
      enableCheck.onCheckChange = function(w)
        _Helper.LowSupplyAlarm.toggleRule(i, w:isChecked())
      end
    end
    ...
    if moveUpButton then
      moveUpButton.onClick = function()
        _Helper.LowSupplyAlarm.moveRuleUp(i)
      end
    end
    ...
    if moveDownButton then
      moveDownButton.onClick = function()
        _Helper.LowSupplyAlarm.moveRuleDown(i)
      end
    end
    ...
    if removeButton then
      removeButton.onClick = function()
        _Helper.LowSupplyAlarm.removeRule(i)
      end
    end
