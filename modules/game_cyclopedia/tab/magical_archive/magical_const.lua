...
function passesVocationFilter(spellVocations, playerVocation)
    ...
    -- Maps vocation names to the IDs returned by translateVocation
    -- translateVocation returns: 8 (EK), 7 (RP), 5 (MS), 6 (ED), 9 (EM)
    local vocationMap = {
        ["Sorcerer"] = {5},
        ["Druid"] = {6},
        ["Paladin"] = {7},
    ...
    -- Maps translateVocation return values to filter keys
    local filterMap = {
        [5] = "sorcererFilter",
        [6] = "druidFilter",
        [7] = "paladinFilter",
